...
public class Panel extends javax.swing.JPanel {
    ...
    MundoCubos controlador;
    
    public Panel(MundoCubos controlador) {
...
@SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jTextField1.setText("S(C,M);S(B,C);S(A,B)");
        ...
        jTextField3.setText("S(A,M);S(B,A);S(C,B)");

        jLabel1.setText("Estado inicial");

        jLabel2.setText("Estado meta");
